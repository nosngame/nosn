...
#ifdef _M_X64
#ifdef _DEBUG
#pragma comment(lib, "../../nsbase/dependency/curl/lib/x64/debug/libcurld.lib")
#pragma comment(lib, "../../nsbase/dependency/mysql/lib/x64/debug/libmysql.lib")
#else
#pragma comment(lib, "../../nsbase/dependency/curl/lib/x64/release/libcurl.lib")
#pragma comment(lib, "../../nsbase/dependency/mysql/lib/x64/release/libmysql.lib")
#endif
#elif _M_IX86
#ifdef _DEBUG
#pragma comment(lib, "../../nsbase/dependency/curl/lib/win32/debug/libcurld.lib")
#pragma comment(lib, "../../nsbase/dependency/mysql/lib/win32/debug/libmysql.lib")
#else
#pragma comment(lib, "../../nsbase/dependency/curl/lib/win32/release/libcurl.lib")
